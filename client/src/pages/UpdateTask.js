  ...
  return (
    <div  className="home">
        ...
        <form className='addtasksec' onSubmit={handleSubmit}>
            <input type='text' name='title' placeholder='What are you working on?' value={title} onChange={handleChange}/>
            <input type='number' name='hours' placeholder='Hours' value={hours} min={0} onChange={handleChange}/>
            <input type='number' name='minutes' placeholder='Minutes' value={minutes} min={0} max={59} onChange={handleChange}/>
            <input type='number' name='seconds' placeholder='Seconds' value={seconds} min={0} max={60} onChange={handleChange}/>
            <input type='date' name='date' placeholder='date' value={date} onChange={handleChange}/>
            <input type='text' name='category' placeholder='Categorize your task' value={category} onChange={handleChange}/>
            <input type='text' name='description' placeholder='Add a Note/Description?' value={description} onChange={handleChange}/>
            <input type='text' name='completed' placeholder='Is task Completed true or false?' value={completed.toString()} onChange={handleChange}/>
            <button type='submit' ><img src={updateIcon} alt='update'/>Update Task</button>
        </form>
    </div>
  )
};
